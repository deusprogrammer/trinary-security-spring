package com.trinary.security.utils;
...
public class TimeUtils {
	public static Date getLaterDate(String duration) throws ParseException {
		return getLaterDate(new Date(), duration);
	}
	
	public static Date getLaterDate(Date start, String duration) throws ParseException {
